...
- Produces constants: `SCRIPT_VERSION=0.1.0`, `HEADROOM_VERSION=0.37.0`, `HEADROOM_PYTHON=3.13`, `HEADROOM_PROFILE=default`, `HEADROOM_PORT=8787`.
...
test_json_audit_has_stable_shape() {
  ...
  assert_equal "$(jq -r '.toolVersion' <<<"$CLI_OUTPUT")" "0.1.0" \
...
- version 0.1.0 and Headroom 0.37.0;
- file map;
